...
- HoneyPot is still an IPA mod for now, but make sure your PH installation has **BepInEx 5.4.5** (other versions may not work. Still testing why HoneyPot is now locked into a super specific version of BepInEx)
