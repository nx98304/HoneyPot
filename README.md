...
- Look into **howto_import_type_definition.zip** in the releases page, if you see any of the following: 
  ...
  - ***It's also possible for HS1 list files*** to have this issue. The current `HSitem_template.unity3d` in the package doesn't have `TextAsset` type definition in it yet. You will have to import this type from other working HS1 list abdatas on your own for now. 
